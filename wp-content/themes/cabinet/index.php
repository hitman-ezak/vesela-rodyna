        ...
        if ($akciya->have_posts()) :
            while ($akciya->have_posts()) :
                ...
                <article class="post">
                    ...
                    <p><?php echo $akciya->post->post_content?></p>
                </article><!--post-->
    ...
    <article class="post-box recipes">
        ...
        if ($category_posts->have_posts()) :
            while ($category_posts->have_posts()) :
                $category_posts->the_post();
                ?>
                <article class="recipes-holder">
                        <a href="<?php echo $category_posts->post->guid?>"><P><?php echo $category_posts->post->post_title?></P></a>
                        <?php the_post_thumbnail('medium')?>
             </article>
                <?php
            endwhile;
